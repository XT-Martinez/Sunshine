...
python3 -m pip install ./packaging/linux/flatpak/deps/flatpak-builder-tools/pip
...
# prepare_ffmpeg_override stop overriding as the build dep already have vulkan support
...
echo "[flatpak] generating glad pip dependencies"
python3 ./packaging/linux/flatpak/deps/flatpak-builder-tools/pip/flatpak-pip-generator.py \
